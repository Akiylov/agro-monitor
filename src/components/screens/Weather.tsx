            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-right space-y-2">
                ...
                <div className="flex items-center justify-end gap-2 text-blue-100">
                  ...
                  <span>45% {t("weather.humidity")}</span>
                </div>
                <div className="flex items-center justify-end gap-2 text-blue-100">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-slate-500">
                Благоприятность для опрыскивания
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        {FORECAST.map((day, i) => {
          ...
          return (
            <Card
              ...
              className={`${
                i === 0
                  ? "border-[#2ECC71] ring-1 ring-[#2ECC71] bg-emerald-50"
                  : ""
              }`}
            >
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <Icon
                  className={`w-8 h-8 mb-2 ${
                    day.rain > 0 ? "text-blue-500" : "text-yellow-500"
                  }`}
                />
                ...
                {day.rain > 0 && (
                  <Badge
                    variant="secondary"
                    className="mt-2 bg-blue-100 text-blue-700 hover:bg-blue-100 text-[10px] px-1.5 py-0 h-5"
                  >
                    {day.rain}%
                  </Badge>
                )}
