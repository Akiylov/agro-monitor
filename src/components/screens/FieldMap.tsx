...
export function FieldMap() {
  ...
  return (
    <div className="flex w-full h-full bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
      ...
      {/* Main Map Area */}
      <div
        className="flex-1 relative bg-slate-200 overflow-hidden group"
        onClick={handleMapClick}
      >
        {/* Map Background Image using the provided asset */}
        <div className="absolute inset-0 z-0">
          <img
            src="./../../assets/imgmoitor.png"
            alt="Map View"
                ...
                <path
                  ...
                  className={cn(
                    ...
                    selectedFieldId === field.id
                      ? "fill-opacity-40 stroke-white stroke-[3px] drop-shadow-lg"
                      : ""
                  )}
                />
              </g>
        ...
        {contextMenu && selectedField && (
          ...
          >
            ...
            <div className="p-1">
              ...
              <ContextMenuItem
                label="Площадь"
                value={`${selectedField.area} га`}
              />
              <ContextMenuItem
                label="Район"
                value={selectedField.details.district}
              />
            </div>
          </div>
        )}
...
function MapButton({
  ...
  return (
    ...
    >
      ...
      {active && (
        <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-[#2ECC71]" />
      )}
    </button>
  );
}
