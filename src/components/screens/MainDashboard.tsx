    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline">{t("common.download_report")}</Button>
        ...
        <Card className="hover:shadow-md transition-shadow border-slate-200">
          <CardContent className="p-5 flex flex-col justify-between h-full">
            <div className="flex justify-between items-start mb-2">
              ...
              <Badge
                variant="outline"
                className="text-emerald-600 bg-emerald-50 border-emerald-100 flex items-center gap-1 text-[10px] px-1.5 h-5"
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Средний показатель по всем активным полям
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="p-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-300 mb-6 max-w-md">
                Аналитика предсказывает оптимальное окно уборки для Пшеницы
                озимой через 12 дней. Проверьте готовность техники.
              </p>
