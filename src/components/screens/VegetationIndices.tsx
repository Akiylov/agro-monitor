          ...
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-emerald-800">
                Вегетация проходит в соответствии с планом. Рекомендуется
                провести плановую фунгицидную обработку через 3 дня.
              </p>
            </CardContent>
          </Card>
        </div>
