...
const mapPreview = "/assets/mapPreview.png";
import { useLanguage } from "../../contexts/LanguageContext";

const MOCK_FILES = [
  {
    id: 1,
    name: "Р.Хайдаров ФХХУ.tif",
    date: "24.08.2023",
    active: true,
    notes: "clone",
  },
  ...
  {
    id: 4,
    name: "Turkiston_FHHU_hududi.tif",
    date: "09.08.2023",
    active: false,
    notes: "clone",
  },
  ...
  {
    id: 6,
    name: "Mirzachul_FHHU_hududi.tif",
    date: "09.08.2023",
    active: true,
    notes: "clone",
    status: "obr",
  ...
  {
    id: 7,
    name: "Mustakillik_kelajagi_FHHU.tif",
    date: "09.08.2023",
    active: false,
    notes: "clone",
  },
    ...
    <div className="flex h-full -m-6">
      ...
      <div className="w-96 bg-white border-r border-slate-200 flex flex-col">
        ...
        <div className="p-4 border-b border-slate-100">
          ...
          <div className="flex space-x-4 text-sm font-medium text-slate-500 border-b border-slate-200">
            <button className="pb-2 border-b-2 border-blue-600 text-blue-600 px-1">
              {t("satellite.images")}
            </button>
            <button className="pb-2 hover:text-slate-800 px-1">
              {t("satellite.import_images")}
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {files.map((file) => (
            <div
              key={file.id}
              className={`flex items-start p-4 border-b border-slate-100 hover:bg-slate-50 transition-colors cursor-pointer ${
                file.selected
            ...
            >
              <div className="flex-1 min-w-0">
                <h3
                  className={`text-sm font-medium truncate ${
                    file.selected ? "text-blue-700" : "text-slate-700"
                  }`}
                >
                  {file.name}
                </h3>
              ...
              <button
                ...
                className={`p-2 rounded-full hover:bg-slate-200 ${
                  file.active ? "text-[#2ECC71]" : "text-slate-300"
                }`}
              >
                {file.active ? (
      ...
      <div className="flex-1 relative bg-slate-100 overflow-hidden flex flex-col">
        ...
        <div className="absolute top-16 left-4 z-10 flex flex-col bg-white rounded-lg shadow-md border border-slate-200 overflow-hidden">
          <button
            className="p-2 hover:bg-slate-50 border-b border-slate-100 text-slate-600"
            title="Layers"
          >
