  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500">{t("integrations.subtitle")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Текущее состояние интеграционных шлюзов
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center text-white text-[10px] font-bold">
                  1C
                </div>
                <div>
                  <div className="font-medium text-slate-900">
                  ...
                  <div className="text-xs text-slate-500">
                    Последняя синхронизация: 1 час назад
                  </div>
                </div>
              </div>
              <Button variant="ghost" size="sm">
